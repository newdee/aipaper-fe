<template>
  <div class="input-card">
    ...
    <div class="chat" id="chat" @click="copyF" >
    </div>
    ...
    <div class="input-card-item">
      ...
      <input v-model="text" placeholder="输入开始对话..." type="text" @keyup.enter="send()" @keyup="removeSEkg()"
  ...
  export default {
    ...
    methods: {
      ...
      send() {
        ...
        avatar = (avatar == "" || avatar == null) ? require("@/assets/images/profile.png") : avatar;
        ...
        const eventSource = new EventSourcePolyfill("https://www.wandou.online/gpt4chat?message=" + encodeURIComponent(
          this.text), {
          headers: {
            'uid': this.uuid_str
          }
