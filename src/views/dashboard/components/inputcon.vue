            ...
            <div class="titleMain">
                ...
                <div class="inputBox">
                    <div class="inputLeft">
                        ...
                        <el-cascader placeholder="请选择科目" v-model="selectValue" :options="homeData.subject_list"
                    ...
                    <div class="inputRight">
                        ...
                        <div class="rightLink g_poin">
                            ...
                            <el-tooltip class="item" effect="dark" content="专业版有什么优势?" placement="top">
                        ...
                        <el-input v-model="input" maxlength="50" show-word-limit
                ...
                <div class="submitBtn">
                    ...
                    <div class="threeLine">
                        <el-tooltip class="item" effect="dark" content="" placement="top">
                            ...
                            <el-switch style="display: block" v-model="value2" active-text="使用三级大纲">
                            </el-switch>
                        </el-tooltip>
                    </div>
                </div>
